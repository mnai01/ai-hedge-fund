---
source_url: https://docs.polymarket.com/api-reference/events/get-event-tags
scraped_at: 2026-02-01T06:07:09.563309
scraper: DocsScraper/1.0
---

Title: Get event tags - Polymarket Documentation

URL Source: https://docs.polymarket.com/api-reference/events/get-event-tags
...
*   Tags 
*   Events 
    *   [GET List events](https://docs.polymarket.com/api-reference/events/list-events)
    *   [GET Get event by id](https://docs.polymarket.com/api-reference/events/get-event-by-id)
    *   [GET Get event tags](https://docs.polymarket.com/api-reference/events/get-event-tags)
    *   [GET Get event by slug](https://docs.polymarket.com/api-reference/events/get-event-by-slug)
