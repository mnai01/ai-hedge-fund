---
source_url: https://docs.polymarket.com/api-reference/data-api-status/data-api-health-check
scraped_at: 2026-02-01T06:07:03.189494
scraper: DocsScraper/1.0
---

Title: Data API Health check - Polymarket Documentation

URL Source: https://docs.polymarket.com/api-reference/data-api-status/data-api-health-check
...
*       *   [GET Data API Health check](https://docs.polymarket.com/api-reference/data-api-status/data-api-health-check)
...
[Search markets, events, and profiles](https://docs.polymarket.com/api-reference/search/search-markets-events-and-profiles)[Download an accounting snapshot (ZIP of CSVs)](https://docs.polymarket.com/api-reference/misc/download-an-accounting-snapshot-zip-of-csvs)
