---
source_url: https://docs.polymarket.com/api-reference/orderbook/get-multiple-order-books-summaries-by-request
scraped_at: 2026-02-01T06:07:54.114352
scraper: DocsScraper/1.0
---

Title: Get multiple order books summaries by request - Polymarket Documentation

URL Source: https://docs.polymarket.com/api-reference/orderbook/get-multiple-order-books-summaries-by-request
...
*   REST API 
    *   Orderbook 
        *   [GET Get order book summary](https://docs.polymarket.com/api-reference/orderbook/get-order-book-summary)
        *   [POST Get multiple order books summaries by request](https://docs.polymarket.com/api-reference/orderbook/get-multiple-order-books-summaries-by-request)
