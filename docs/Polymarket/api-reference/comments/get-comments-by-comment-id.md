---
source_url: https://docs.polymarket.com/api-reference/comments/get-comments-by-comment-id
scraped_at: 2026-02-01T06:06:15.958321
scraper: DocsScraper/1.0
---

Title: Get comments by comment id - Polymarket Documentation

URL Source: https://docs.polymarket.com/api-reference/comments/get-comments-by-comment-id
...
*   Series 
*   Comments 
    *   [GET List comments](https://docs.polymarket.com/api-reference/comments/list-comments)
    *   [GET Get comments by comment id](https://docs.polymarket.com/api-reference/comments/get-comments-by-comment-id)
    *   [GET Get comments by user address](https://docs.polymarket.com/api-reference/comments/get-comments-by-user-address)
