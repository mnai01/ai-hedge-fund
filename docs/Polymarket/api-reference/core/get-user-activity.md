---
source_url: https://docs.polymarket.com/api-reference/core/get-user-activity
scraped_at: 2026-02-01T06:06:56.940240
scraper: DocsScraper/1.0
---

Title: Get user activity - Polymarket Documentation

URL Source: https://docs.polymarket.com/api-reference/core/get-user-activity
...
*   Misc 
*   Core 
    *   [GET Get current positions for a user](https://docs.polymarket.com/api-reference/core/get-current-positions-for-a-user)
    *   [GET Get trades for a user or markets](https://docs.polymarket.com/api-reference/core/get-trades-for-a-user-or-markets)
    *   [GET Get user activity](https://docs.polymarket.com/api-reference/core/get-user-activity)
    *   [GET Get top holders for markets](https://docs.polymarket.com/api-reference/core/get-top-holders-for-markets)
    *   [GET Get total value of a user's positions](https://docs.polymarket.com/api-reference/core/get-total-value-of-a-users-positions)
    *   [GET Get closed positions for a user](https://docs.polymarket.com/api-reference/core/get-closed-positions-for-a-user)
    *   [GET Get trader leaderboard rankings](https://docs.polymarket.com/api-reference/core/get-trader-leaderboard-rankings)
