---
source_url: https://docs.polymarket.com/developers/RTDS/RTDS-comments
scraped_at: 2026-01-31T22:33:13.306028
scraper: DocsScraper/1.0
---

Title: RTDS Comments - Polymarket Documentation

URL Source: https://docs.polymarket.com/developers/RTDS/RTDS-comments

Markdown Content:
[TypeScript client ----------------- Official RTDS TypeScript client (`real-time-data-client`).](https://github.com/Polymarket/real-time-data-client)
Overview
--------
